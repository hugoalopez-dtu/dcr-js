...
[train_agent.py:9](dcr-gymnasium-agent/python/src/agents/train_agent.py#L9):
```python
from stable_baselines3 import PPO
```
[train_agent.py:245-252](dcr-gymnasium-agent/python/src/agents/train_agent.py#L245-L252):
```python
model = PPO(
    "MlpPolicy",
    vec_env,
...
/Users/sofia/dcr-js/dcr-gymnasium-agent/python/src/agents/train_agent.py
```
The only hit is [train_agent.py:227](dcr-gymnasium-agent/python/src/agents/train_agent.py#L227):
```python
...
- Client side, [dcr_env.py:25-31](dcr-gymnasium-agent/python/src/envs/dcr_env.py#L25-L31) and
  [dcr_env.py:56-58, 74, 86, 94](dcr-gymnasium-agent/python/src/envs/dcr_env.py#L56-L94):
  ...
  [train_agent.py:81-103](dcr-gymnasium-agent/python/src/agents/train_agent.py#L81-L103)).
...
- On truncation (`maxStepReached=true`, `accepting=false`): `done=True` is
  ...
  [dcr_env.py:103](dcr-gymnasium-agent/python/src/envs/dcr_env.py#L103),
...
- The episode is counted as **non-accepting**: `accepting=false`,
  ...
  ([train_agent.py:177-184](dcr-gymnasium-agent/python/src/agents/train_agent.py#L177-L184)),
